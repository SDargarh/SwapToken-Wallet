...
module.exports = async function (callback) {
  const deployed = await SwapTokensWallet.deployed();

  const currentValue = (await deployed.read()).toNumber();
  console.log(`Current SwapTokensWallet value: ${currentValue}`);
  ...
  console.log(`Updated SwapTokensWallet value: ${updatedValue}`);
